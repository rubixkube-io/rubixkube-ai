...
import { Mail, MapPin, Send, Clock, MessageSquare, Check, ArrowRight } from 'lucide-react'
        ...
        <div className="rk-landing-max px-[var(--pad)]">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-[380px_1fr] lg:items-start">
            ...
            >
              {contactMethods.map((method) => (
                <motion.a
                  ...
                  href={method.href}
                  variants={fadeUpVariants}
                  className="group flex items-start gap-4 border border-[var(--rule)] p-5 transition-all duration-300 hover:-translate-y-0.5 hover:border-[var(--rule)] hover:shadow-md hover:shadow-black/[0.04]"
                >
              ...
              <motion.div
                variants={fadeUpVariants}
                className="mt-6 border-t border-[var(--rule)] pt-6"
              >
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true, margin: '-8% 0px' }}
              className="rounded-xl border border-[var(--rule)]/60 bg-[#f6f6f4] p-8 shadow-xl shadow-black/[0.03] sm:p-10"
            >
